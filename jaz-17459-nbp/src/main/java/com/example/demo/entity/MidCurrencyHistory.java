...
public class MidCurrencyHistory {
    ...
    @ApiModelProperty(notes = "Date From: format 2022-01-01", required = true, dataType = "LocalDate")
    private LocalDate dateFrom = RestTemplateConfig.getDate();
    @ApiModelProperty(notes = "Date To: format 2022-01-01", required = true, dataType = "LocalDate")
